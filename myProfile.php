...
<head>
    ...
    <body>
        ...
        <br/>
        <button id="photography" onclick="page(this.id);">Photography</button><br/>
        <button id="resume" onclick="page(this.id);">Resume</button><br/>
        <button id="github" onclick="page(this.id);">Github</button><br/>
        <button id="linkedin" onclick="page(this.id);">Linked In</button>
        <br>
